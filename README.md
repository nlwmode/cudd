...
### **Tutorial**
Yous can find a tutorials from david kebo's website: [https://davidkebo.com/cudd](https://davidkebo.com/cudd), 
Or you can also visit these tutorial files under cudd/doc/ directory.

### **API and Doc**
For detailed APIs and documents, you can visit on https://web.archive.org/ by Fabio Somenzi:
- cudd 3.0.0: [https://web.archive.org/web/20180127051756/http://vlsi.colorado.edu/~fabio/CUDD/html/index.html](https://web.archive.org/web/20180127051756/http://vlsi.colorado.edu/~fabio/CUDD/html/index.html) 
- cudd 2.5.0: [https://web.archive.org/web/20150215010018/http://vlsi.colorado.edu/~fabio/CUDD/cuddIntro.html](https://web.archive.org/web/20150215010018/http://vlsi.colorado.edu/~fabio/CUDD/cuddIntro.html)


### **Version**
Current version is cudd-3.0.0, and I also download the cudd-2.4.2, cudd-2.5.0, cudd-2.5.1 project to cudd/archives directory.
